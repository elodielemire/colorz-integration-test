...
function Header() {
    return (
        <div className="header center">
            <Navbar />
            <h3 className="header__subtitle fw-4 fs-16-lh-24 main-color">Du JAMAIS VU (enfin jusquՈ maintenant, du coup)</h3>
            ...
            <div className="header__circle bg-main-color">
                <p className="header__circle__title fw-4 fs-12-lh-14--responsive text-white">Offre speciale</p>
