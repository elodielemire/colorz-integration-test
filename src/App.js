      ...
      <Header />
        ...
        <section className="section-technology">
            <div className="section-technology__text">
                <p className="section-technology__text__title fs-22-lh-34--responsive center mbo-15">The most advanced technology</p>
                <p className="section-technology__text__subtitle fw-4 fs-16-lh-24--responsive center mbo-45">Only 3mm of Carton-Plume de qualité for une expérience maximale ! We travelled all around the world, we
        ...
        <div className="section-locker">
            ...
            <div className="section-locker__text">
                ...
                <p className="fs-22-lh-34--responsive mbo-21">The pudique (or je suis en pyjama et j’assume pas) effect</p>
        ...
        <div className="section-quote bg-main-color center">
            <p className="text-white fs-22-lh-34--responsive mbo-15">“ Le grand écart technologique que tout le monde attendait ! ”</p>
            <p className="text-white fw-4 fs-16-lh-24">Jean-Claude Van Damme</p>
        </div>
        <section className="section-swiper">
            <p className="section-swiper__title fs-30-lh-42--responsive center mbo-40">Some indispensables accessoires to optimize your experience</p>
            <Swiper/>
        </section>
        <Footer/>
    </div>
